  ...
  return (
    <div className="flex gap-5 flex-wrap flex-row flex-center justify-start mt-6">
      ...
      <CardStatistic
        ...
        value={stats?.data?.in_progress_service_requests ?? 0}
        classesName={[
      ...
      <CardStatistic
        ...
        value={stats?.data?.locked_balance ?? 0}
        classesName={[
