...
import { OptionType, type ConsulationFormPayload, type ConsulationQuestionsResponse, type Question } from "./model/consultationModel";

export const createUpdateQuestions = async (payload: ConsulationFormPayload) => {
