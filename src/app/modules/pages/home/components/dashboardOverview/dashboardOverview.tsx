    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 my-4">
        <Card
          type="overview"
          label="العملاء الجدد"
          value={`${dashboardOverview?.new_clients ?? 0}`}
          text="عميل جديد"
          className="bg-white p-2"
        >
          <div className="flex gap-1 items-center">
            <div className={`${Math.random() > 0.5 ? "" : "rotate-180"}`}>
              <svg
            ...
            <p className="text-green-600 font-semibold">+ %68</p>
        ...
        <Card
          ...
          value={`${dashboardOverview?.in_progress_requests ?? 0}`}
          text="طلب جديد"
          className="bg-white p-2"
        >
          <div className="flex gap-1 items-center">
        ...
        <Card
          ...
          value={`${dashboardOverview?.new_requests ?? 0}`}
          text="طلب جاري"
          className="bg-white p-2"
        >
          <div className="flex gap-1 items-center">
        ...
        <Card
          ...
          value={`${dashboardOverview?.completed_requests ?? 0}`}
          text="طلب مكتمل"
          className="bg-white p-2"
        >
          <div className="flex gap-1 items-center">
